...
# The tail fixes a sizing failure: plotly falls back to a fixed 700px when
# its container has no width at draw time (a background tab, a layout still
...
<div style="flex:1 1 130px; text-align:center; padding:0.9rem 0.4rem; background:#FDFBF7; border-radius:8px;">
<div style="font-size:1.7rem; font-weight:700; color:#2E1A47;">1,354</div>
<div style="font-size:0.8rem; color:#666;">people followed</div>
</div>
<div style="flex:1 1 130px; text-align:center; padding:0.9rem 0.4rem; background:#FDFBF7; border-radius:8px;">
<div style="font-size:1.7rem; font-weight:700; color:#2E1A47;">11</div>
<div style="font-size:0.8rem; color:#666;">interview waves</div>
</div>
<div style="flex:1 1 130px; text-align:center; padding:0.9rem 0.4rem; background:#FDFBF7; border-radius:8px;">
<div style="font-size:1.7rem; font-weight:700; color:#2E1A47;">7</div>
<div style="font-size:0.8rem; color:#666;">years of follow-up</div>
</div>
<div style="flex:1 1 130px; text-align:center; padding:0.9rem 0.4rem; background:#FDFBF7; border-radius:8px;">
<div style="font-size:1.7rem; font-weight:700; color:#2E1A47;">14 to 26</div>
