  ...
  <div class="row align-items-center">
    <div class="col-md-9">
      ...
      <p class="hero-intro">
        ...
        datasets, practical methodology, and visualizations that actually stick.
      </p>
    </div>
  </div>
</div>
...
<div class="bio-block">
  ...
  <div class="bio-body">
    ...
    decisions and interventions — the places where a well-meaning rule meets a
    messy world.</p>
...
<div class="focus-grid">
  ...
  <div class="focus-card" style="--accent:#E98973;">
    ...
    <p class="focus-card-text">
      ...
      programs — measuring whether an intervention actually does what it
      promises.
    </p>
  </div>
  ...
  <div class="focus-card" style="--accent:#B5835A;">
    ...
    <p class="focus-card-text">
      ...
      something a judge, funder, or community will actually read and remember —
...
<div class="project-grid">
  <div class="project-card">
    ...
    <p class="project-card-desc">
      ...
      communication, and visualization design — using a subject matter
      executives actually argue about.
    </p>
