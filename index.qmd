...
<div class="hero-section container">
  <div class="row align-items-center">
    <div class="col-md-9">
      ...
      <svg class="hero-motif" viewBox="0 0 220 34" width="220" height="34" aria-hidden="true" focusable="false">
        <defs>
        ...
        <path d="M 6 28 C 60 26, 120 18, 214 6" fill="none" stroke="url(#motif-line)" stroke-width="2" stroke-linecap="round"/>
...
<div class="bio-block">
  ...
  <div class="bio-body">
    ...
    outcomes, and what happens downstream when those choices are treated as
    facts.</p>

    <div class="credential-badges">
      <span class="badge-item">PhD, Social Psychology · concentration in Research Design &amp; Data Analysis</span>
    ...
    meets a complicated reality. That interest isn't purely academic: it's
    shaped in part by my own experience with the legal system as a young
    person.</p>
    ...
    Institute. I've led federally funded research and multi-state
    evaluations across diversion, pretrial, and therapeutic courts. In
    2025, I received the INSPIRE Lincoln Award.</p>
