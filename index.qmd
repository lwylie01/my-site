---
title: ""
pagetitle: "Data with a Plot"
description: "Adult at 18. Senior at 65. Every bright line misses the ones in between. I tell their stories with data."
page-layout: full
toc: true
...
<div class="project-grid">
  ...
  <div class="project-card">
    ...
    <p class="project-card-desc">
      Young adults, the legal system, and the data between them: federal
      arrest, prison, and recidivism numbers, then a study that measured the
      same 1,354 people growing up, with a note under every figure on why
      that chart form got the job.
    </p>
  </div>
</div>
```

::: {style="text-align: center; padding: 3rem 0 1rem; color: #6A5F72; font-size: 0.9rem;"}
Built with [Quarto](https://quarto.org) · Hosted on [GitHub
Pages](https://pages.github.com)

<span style="display:block; margin-top:0.5rem; font-size:0.8rem; color:#6A5F72; font-style:italic;">n = 1 website. Results may not generalize.</span>
:::
