...
<div class="hero-section container">
  <div class="row align-items-center">
    <div class="col-md-9">
      ...
      <p class="hero-intro">
        Careful analysis, made accessible: unexpected datasets, practical
        methods, and visuals built to be understood and remembered.
      </p>
    </div>
  </div>
</div>
...
<div class="bio-block">
  ...
  <div class="bio-body">
    <p>I study how data shapes decisions and legal policy, with specific
    attention to how measurement changes outcomes.</p>
    ...
    decisions: what happens when a well-meant law or policy meets the reality
    of a complex system. My interests are shaped by my experience as a
    system-involved young person and my desire to highlight under-studied
    research topics.</p>
...
<div class="project-grid">
  ...
  <div class="project-card">
    ...
    <p class="project-card-desc">
      ...
      asks how accurate it feels, then reveals that everyone gets the exact
      same text. A clear, memorable lesson in construct validity.
    </p>
    <div class="project-card-meta">
      <span><span class="project-card-accent" style="background:#8C6A8D;"></span>R / Quarto</span>
