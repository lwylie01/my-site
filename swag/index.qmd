...
.swag-host-slot{width:122px;height:122px;border-radius:50%;overflow:hidden;margin:0 auto .5rem;border:2px solid #F4715C;box-shadow:0 4px 14px rgba(46,26,71,.12);background:#FDFBF7}
.swag-host-slot img{width:100%;height:100%;object-fit:cover;display:block;transform:scale(1.12);transform-origin:50% 20%}
.swag-host-cap{font-family:var(--bs-font-monospace,'JetBrains Mono',monospace);font-size:.7rem;letter-spacing:.1em;text-transform:uppercase;color:#6A5F72;line-height:1.4}
...
.swag-gallery a{display:block;border:1px solid #E7DED0;border-radius:10px;background:#FDFBF7;padding:.75rem;text-align:center;text-decoration:none;transition:box-shadow .2s ease,transform .2s ease}
.swag-gallery a:hover{box-shadow:0 4px 16px rgba(46,26,71,.10);transform:translateY(-2px)}
.swag-gallery a:focus-visible{outline:2px solid #B23A28;outline-offset:2px}
.swag-gallery img{width:100%;height:118px;object-fit:contain;display:block;margin-bottom:.55rem}
.swag-gallery .cap{font-family:var(--bs-font-monospace,'JetBrains Mono',monospace);font-size:.7rem;letter-spacing:.08em;text-transform:uppercase;color:#6A5F72;line-height:1.3}
...
/* character stickers fold: quiet by default, mirrors details.codebook-fold */
.swag-fold{margin:.2rem 0 .6rem;border-top:1px solid #E5DCCF;padding-top:.4rem}
.swag-fold>summary{cursor:pointer;list-style:none;font-family:var(--bs-font-monospace,'JetBrains Mono',monospace);font-size:.72rem;font-weight:500;letter-spacing:.08em;text-transform:uppercase;color:#B23A28;padding:.55rem .2rem}
.swag-fold>summary::-webkit-details-marker{display:none}
.swag-fold>summary::before{content:"\25B8\00A0"}
.swag-fold[open]>summary::before{content:"\25BE\00A0"}
.swag-fold>summary:focus-visible{outline:2px solid #B23A28;outline-offset:2px;border-radius:4px}
.swag-fold .swag-gallery{margin-top:.4rem}
...
<div class="page-header container swag-header">
  ...
  <p class="page-header-sub">The arc, the scatter, and the one dot the line misses, put on things. The stickers and shirt art download as real files; the mugs and totes are mockups, statistically insignificant as merch but the art is yours to keep.</p>
  <div class="swag-host">
...
<section class="swag-act">
  ...
  <p class="swag-lead">Stickers and shirt art, yours to take. Every design in this section hands you a real file.</p>

  <h3 class="swag-subhead">Quote Stickers</h3>
  ...
  <div class="swag-gallery">
    <a href="downloads/stickers/sticker-spaghetti-has-no-protagonist.png" download><img src="downloads/stickers/sticker-spaghetti-has-no-protagonist.png" alt="Sticker: tangled multi-colour lines, 'Spaghetti Has No Protagonist'" loading="lazy" decoding="async"><span class="cap">Spaghetti Has No Protagonist</span></a>
    <a href="downloads/stickers/sticker-practically-significant.png" download><img src="downloads/stickers/sticker-practically-significant.png" alt="Sticker: 'p &lt; .05, Practically Significant'" loading="lazy" decoding="async"><span class="cap">Practically Significant</span></a>
    <a href="downloads/stickers/sticker-the-outlier-the-line-misses.png" download><img src="downloads/stickers/sticker-the-outlier-the-line-misses.png" alt="Sticker: the arc past a coral dot, 'The Outlier the Line Misses'" loading="lazy" decoding="async"><span class="cap">The Outlier the Line Misses</span></a>
    <a href="downloads/stickers/sticker-be-the-outlier.png" download><img src="downloads/stickers/sticker-be-the-outlier.png" alt="Sticker: a coral badge holding the illustrated host portrait, 'Be the Outlier'" loading="lazy" decoding="async"><span class="cap">Be the Outlier</span></a>
    <a href="downloads/stickers/sticker-clarity-is-kindness.png" download><img src="downloads/stickers/sticker-clarity-is-kindness.png" alt="Sticker: 'Clarity Is Kindness' over a coral underline" loading="lazy" decoding="async"><span class="cap">Clarity Is Kindness</span></a>
  </div>
  ...
  <details class="swag-fold">
    <summary>More stickers: the characters and the bare marks</summary>
    <div class="swag-gallery">
  ...
  <a href="downloads/stickers/sticker-the-mark.png" download><img src="downloads/stickers/sticker-the-mark.png" alt="Sticker: the bare arc-and-pen mark" loading="lazy" decoding="async"><span class="cap">The Mark</span></a>
  <a href="downloads/stickers/sticker-the-mark-and-scatter.png" download><img src="downloads/stickers/sticker-the-mark-and-scatter.png" alt="Sticker: the arc-and-pen mark through a scatter of dots" loading="lazy" decoding="async"><span class="cap">The Mark and Scatter</span></a>
    </div>
  </details>

  <h3 class="swag-subhead">Shirt Art</h3>
  <p class="swag-subnote">Six flat print designs. The tees and hoodie are mockups, but grab any design on its own, or take the whole pack.</p>
  ...
  <div class="project-grid">
    ...
    <div class="project-card">
      <span class="swag-art swag-svg" aria-hidden="true"><svg focusable="false" viewBox="0 0 300 250" fill="none">
      ...
      <p class="source-chips"><a class="chip-link" href="downloads/shirts/shirt-the-line-at-18.png" download aria-label="Download The Line at 18, PNG">PNG (transparent)</a></p>
    </div>
    ...
    <div class="project-card">
      ...
      <p class="project-card-desc">My tagline, from the site's own social card, under the arc and the one it misses.</p>
      <p class="source-chips"><a class="chip-link" href="downloads/shirts/shirt-i-tell-their-stories-with-data.png" download aria-label="Download I Tell Their Stories With Data, PNG">PNG (transparent)</a></p>
    </div>
    ...
    <div class="project-card">
      ...
      <p class="project-card-desc">My working premise, set plain. The one that reads from across a room.</p>
      <p class="source-chips"><a class="chip-link" href="downloads/shirts/shirt-clarity-is-kindness.png" download aria-label="Download Clarity Is Kindness, PNG">PNG (transparent)</a></p>
    </div>

    <div class="project-card">
      <span class="swag-art swag-art--dark swag-svg" aria-hidden="true"><svg focusable="false" viewBox="0 0 300 250" fill="none">
      ...
      <p class="source-chips"><a class="chip-link" href="downloads/shirts/shirt-the-wordmark.png" download aria-label="Download The Wordmark, PNG">PNG (on ink)</a></p>
    </div>
    ...
    <div class="project-card">
      ...
      <p class="source-chips"><a class="chip-link" href="downloads/shirts/shirt-small-sample-significant-effect.png" download aria-label="Download Small Sample, Significant Effect, PNG">PNG (transparent)</a></p>
    </div>
