...
<section class="swag-act">
  ...
  <p class="swag-eyebrow" style="margin-top:.6rem">Character Stickers</p>
  <div class="project-grid">

    <div class="project-card">
      <span class="swag-art"><img src="pics/sticker-data-plot.png" alt="Sticker: the mascot beside the Data with a Plot wordmark" loading="lazy"></span>
      <span class="project-card-tag">Sticker · Download</span>
      <p class="project-card-title">Data With a Plot</p>
      <p class="source-chips"><a class="chip-link" href="pics/sticker-data-plot.png" download>PNG (transparent)</a></p>
    </div>

    <div class="project-card">
      <span class="swag-art"><img src="pics/sticker-you-got-this.png" alt="Sticker: the mascot giving a thumbs up, 'You Got This'" loading="lazy"></span>
      <span class="project-card-tag">Sticker · Download</span>
      <p class="project-card-title">You Got This</p>
      <p class="source-chips"><a class="chip-link" href="pics/sticker-you-got-this.png" download>PNG (transparent)</a></p>
    </div>

    <div class="project-card">
      <span class="swag-art"><img src="pics/sticker-plot-twist.png" alt="Sticker: the mascot and a little monitor, 'Plot Twist'" loading="lazy"></span>
      <span class="project-card-tag">Sticker · Download</span>
      <p class="project-card-title">Plot Twist</p>
      <p class="source-chips"><a class="chip-link" href="pics/sticker-plot-twist.png" download>PNG (transparent)</a></p>
    </div>

    <div class="project-card">
      <span class="swag-art"><img src="pics/sticker-good-idea.png" alt="Sticker: the mascot with a lightbulb, 'Good Idea'" loading="lazy"></span>
      <span class="project-card-tag">Sticker · Download</span>
      <p class="project-card-title">Good Idea</p>
      <p class="source-chips"><a class="chip-link" href="pics/sticker-good-idea.png" download>PNG (transparent)</a></p>
    </div>

    <div class="project-card">
      <span class="swag-art"><img src="pics/sticker-coffee-fuel.png" alt="Sticker: the mascot holding a mug, 'Coffee = Fuel'" loading="lazy"></span>
      <span class="project-card-tag">Sticker · Download</span>
      <p class="project-card-title">Coffee = Fuel</p>
      <p class="source-chips"><a class="chip-link" href="pics/sticker-coffee-fuel.png" download>PNG (transparent)</a></p>
    </div>

    <div class="project-card">
      <span class="swag-art"><img src="pics/sticker-thinking.png" alt="Sticker: the mascot thinking, 'Thinking...'" loading="lazy"></span>
      <span class="project-card-tag">Sticker · Download</span>
      <p class="project-card-title">Thinking…</p>
      <p class="source-chips"><a class="chip-link" href="pics/sticker-thinking.png" download>PNG (transparent)</a></p>
    </div>

  </div>

  <p class="swag-eyebrow" style="margin-top:2.4rem">Motifs and Wallpapers</p>
  <div class="project-grid">
...
<section class="swag-act">
  ...
  <p class="swag-eyebrow" style="margin-top:2.6rem">The Applied Kit</p>
  <div class="project-grid">

    <div class="project-card">
      <span class="swag-art"><img src="pics/kit-tote.png" alt="Tote bag with the mark and 'the story is in the scatter'"></span>
    ...
    <div class="project-card">
      <span class="swag-art"><img src="pics/kit-mug.png" alt="Mug reading 'not statistically significant before coffee'"></span>
    ...
    <div class="project-card">
      <span class="swag-art"><img src="pics/kit-laptop.png" alt="Laptop lid decal reading 'n = 1 website, may not generalize'"></span>
    ...
    <div class="project-card">
      <span class="swag-art"><img src="pics/kit-card.png" alt="Business card, front and back"></span>
      ...
      <p class="source-chips"><span class="swag-showcase-note">Showcase only</span></p>
    </div>

    <div class="project-card">
      <span class="swag-art"><img src="pics/kit-slides.png" alt="Slide template: a title slide and a content slide"></span>
