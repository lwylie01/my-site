...
<div class="page-header container swag-header">
  ...
  <p class="page-header-sub">The arc, the scatter, and the one dot the line misses, put on things. The stickers download as real files; the shirts and the rest are mockups, statistically insignificant as merch but the art is yours to keep.</p>
  <div class="swag-host">
...
<section class="swag-act">
  ...
  <div class="project-grid">
    ...
    <div class="project-card">
      ...
      <p class="source-chips"><a class="chip-link" href="downloads/shirts/shirt-the-line-at-18.png" download>PNG (transparent)</a></p>
    </div>
    ...
    <div class="project-card">
      ...
      <p class="source-chips"><a class="chip-link" href="downloads/shirts/shirt-i-tell-their-stories-with-data.png" download>PNG (transparent)</a></p>
    </div>
    ...
    <div class="project-card">
      ...
      <p class="source-chips"><a class="chip-link" href="downloads/shirts/shirt-clarity-is-kindness.png" download>PNG (transparent)</a></p>
    </div>
    ...
    <div class="project-card">
      ...
      <p class="source-chips"><a class="chip-link" href="downloads/shirts/shirt-the-wordmark.png" download>PNG (on ink)</a></p>
    </div>
    ...
    <div class="project-card">
      ...
      <p class="source-chips"><a class="chip-link" href="downloads/shirts/shirt-small-sample-significant-effect.png" download>PNG (transparent)</a></p>
    </div>
    ...
    <div class="project-card">
      ...
      <p class="source-chips"><a class="chip-link" href="downloads/shirts/shirt-women-in-stem.png" download>PNG (transparent)</a></p>
    </div>
